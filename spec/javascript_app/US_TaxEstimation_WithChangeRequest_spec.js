describe("Employee of <ABC> Inc:", function() {
    describe("Tax Estimation:", function() {
        ...
        beforeEach(function() {
            ...
            jasmine.getJSONFixtures().fixturesPath = '../spec/javascript_app/data';
        ...
        describe("Category: Single Taxpayer", function() {
            ...
            describe("When: Taxable income is $111,200: ", function() {
                ...
                it("10 percent Tax Rate should be applied for the income between $0 and $9,075", function() {
                    expect(myTDS_TaxBracket[0]).toEqual(907.5);
                });
                it("Tax on income  $0 to $9,075 + " +
                    "15 percent Tax Rate should be applied for the income between $9,076 and $36,900", function() {
                    expect(myTDS_TaxBracket[2]).toEqual(18193.75);
                });
                it("Tax on income  $0 to $36,900 + " +
                    "25 percent Tax Rate should be applied for the income between $36,901 and $89,350", function() {
                    expect(myTDS_TaxBracket[2]).toEqual(18193.75);
                });
                it("Tax on income  $0 to $89,350 + " +
                    "28 percent Tax Rate should be applied for the income between $89,351 and $186,350", function() {
            ...
            describe("When: Taxable income is $450,000: ", function() {
                ...
                it("Tax on income  $0 to $9,075 + " + "15 percent Tax Rate should be applied for the income between $9,076 and $36,900", function() {
                    expect(myTDS_TaxBracket[1]).toEqual(5081.25);
                });
                it("Tax on income  $0 to $36,900 + " + "25 percent Tax Rate should be applied for the income between $36,901 and $89,350", function() {
                    expect(myTDS_TaxBracket[2]).toEqual(18193.75);
                });
                it("Tax on income  $0 to $89,350 + " + "28 percent Tax Rate should be applied for the income between $89,351 and $186,350", function() {
                    expect(myTDS_TaxBracket[3]).toEqual(45353.75);
                });
                it("Tax on income  $0 to $186,350 + " + "33 percent Tax Rate should be applied for the income between $186,351 and $405,100", function() {
                    expect(myTDS_TaxBracket[4]).toEqual(117541.25);
                });
                it("Tax on income  $0 to $405,100 + " + "35 percent Tax Rate should be applied for the income between $405,101 and $406,750", function() {
                    expect(myTDS_TaxBracket[5]).toEqual(118118.75);
                });
                it("Tax on income  $0 to $406,750 + " + "39.6 percent Tax Rate should be applied for the income more than $406,750", function() {
