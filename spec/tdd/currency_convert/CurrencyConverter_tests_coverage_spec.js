describe("<ABC> Money Exchange Company: Currency Converter Module", function() {
    describe("When Convert Currency Across Region: ", function() {
        ...
        it("Verify that South African Rand (ZAR) converted to " + "Indian Rupees (INR)", function() {
        ...
        it("Verify that Indian Rupees (INR) " + "converted to Us Dollars (USD) " + "with Higher Exchange Rate", function() {
